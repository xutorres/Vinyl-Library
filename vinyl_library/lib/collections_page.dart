...
import 'collection_detail_page.dart'; // This page displays the records in the collection
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  title: Text(listName),
                  // Nested StreamBuilder to count the number of records in the collection.
                  subtitle: StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, recordSnapshot) {
                      ...
                      final int recordCount = recordSnapshot.data!.docs.length;
                      return Text("$recordCount record${recordCount == 1 ? "" : "s"}");
                    },
                  ),
                  // When tapped, navigate to the CollectionDetailPage.
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
